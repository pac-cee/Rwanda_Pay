...
function AuthModal({
  ...
  return (
    <View style={StyleSheet.absoluteFillObject}>
      ...
      <Animated.View style={[authStyles.sheet, { backgroundColor: colors.card }, sheetStyle]}>
...
const authStyles = StyleSheet.create({
  ...
  sheet: {
    ...
    padding: 28, paddingBottom: 48, alignItems: "center", gap: 14,
  },
  ...
  authBtn: {
    ...
    width: "100%", height: 54, borderRadius: 16, justifyContent: "center", marginTop: 8,
  },
...
export default function PayScreen() {
  ...
  const { selectedCard, refreshWallet, hideBalance } = useWallet();
    ...
    <View style={[styles.screen, { backgroundColor: colors.background }]}>
      <KeyboardAvoidingView style={{ flex: 1 }} behavior={Platform.OS === "ios" ? "padding" : "height"}>
        ...
        >
          ...
          {selectedCard ? (
            <Animated.View style={[styles.cardWrap, isTerminalFound && rippleStyle]}>
          ...
          {isSuccess && (
            <View style={[styles.resultBox, { backgroundColor: `${colors.success}15` }]}>
              ...
              <Text style={[styles.resultText, { color: colors.success }]}>
                {merchant || "Merchant"} · {parseInt(amount || "0").toLocaleString("en-RW") || "–"} RWF
              </Text>
            </View>
          )}
...
const styles = StyleSheet.create({
  ...
  terminalBox: {
    flexDirection: "row", alignItems: "center", gap: 10,
    width: "100%", padding: 14, borderRadius: 14, borderWidth: 1,
  },
  terminalText: { fontSize: 14, fontFamily: "Inter_600SemiBold", flex: 1 },
  resultBox: { flexDirection: "row", alignItems: "center", gap: 10, width: "100%", padding: 14, borderRadius: 14 },
