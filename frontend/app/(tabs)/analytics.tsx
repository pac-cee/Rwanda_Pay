...
export default function AnalyticsScreen() {
  ...
  // Weekly chart: spending per day of week
  ...
  const categoryBreakdown = useMemo(() => {
    ...
    return (Object.entries(totals) as [TransactionCategory, number][])
      .sort((a, b) => b[1] - a[1]);
  }, [filtered]);
        ...
        {(["week", "month"] as Period[]).map((p) => (
          ...
          >
            <Text
              style={[
                styles.periodText,
                { color: p === period ? "#FFFFFF" : colors.mutedForeground },
              ]}
            >
