          ...
          {row.map((cell, ci) => (
            <View
              ...
              style={{
                ...
                height: 28,
                borderRadius: 4,
                backgroundColor: cell ? foreground : "transparent",
              }}
            />
          ))}
        </View>
...
export default function ReceiveScreen() {
  ...
  const { profile, selectedCard } = useWallet();
    ...
    >
      ...
      <View style={styles.content}>
        ...
        <View style={[styles.idCard, { backgroundColor: colors.card, borderColor: colors.border }]}>
          <View>
            <Text style={[styles.idLabel, { color: colors.mutedForeground }]}>Rwanda Pay ID</Text>
            <Text style={[styles.idValue, { color: colors.foreground }]}>{profile.phone}</Text>
          </View>
          <Pressable
            style={({ pressed }) => [
              styles.copyBtn,
        ...
        <View style={[styles.infoBox, { backgroundColor: `${colors.secondary}12` }]}>
          ...
          <Text style={[styles.infoText, { color: colors.secondary }]}>
            Payments sent to your Rwanda Pay ID will appear instantly in your transaction history.
          </Text>
        </View>
      </View>
    </ScrollView>
...
const styles = StyleSheet.create({
  ...
  idValue: { fontSize: 18, fontFamily: "Inter_700Bold", letterSpacing: 0.5 },
